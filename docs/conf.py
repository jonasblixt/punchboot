...
latex_documents = [
  (master_doc, 'punchboot-tools.tex', u'Punchboot-tools documentation',
...
texinfo_documents = [
  (master_doc, 'Punchboot-tools', u'Punchboot documentation',
   author, 'Punchboot-tools', 'One line description of project.',
   'Miscellaneous'),
]
