...
$PB part --force --resize 2048 --part c046ccd8-0f2e-4036-984d-76c14dc73992 \
         --transport socket
result_code=$?
...
sgdisk -i 2 /tmp/disk | grep "Last sector: 3105"
result_code=$?

if [ $result_code -ne 0 ];
then
    echo Last sector is not 3105
    test_end_error
fi

# Check adjacent partition

sgdisk -i 3 /tmp/disk | grep "First sector: 3106"
result_code=$?

if [ $result_code -ne 0 ];
then
    echo First sector in adjacent partition is not 3106
    test_end_error
fi
