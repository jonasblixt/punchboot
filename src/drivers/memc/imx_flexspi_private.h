...
#define FLEXSPI_FLSHCR1(n)          (0x0070 + (n * 4))
#define FLEXSPI_FLSHCR2(n)          (0x0080 + (n * 4))
#define FLEXSPI_FLSHCR4             (0x0094)

#define FLEXSPI_IPCR0               (0x00A0)
#define FLEXSPI_DLLACR              (0x00C0)
#define FLEXSPI_DLLBCR              (0x00C4)
#define FLEXSPI_LUTKEY              (0x0018)
#define FLEXSPI_LUTCR               (0x001C)
#define FLEXSPI_LUT                 (0x0200)
