...
#define DEFINE_COPROCR_READ_FUNC(_name, ...)  _DEFINE_COPROCR_READ_FUNC(_name, __VA_ARGS__)

/* Define write function for coproc register */
#define DEFINE_COPROCR_WRITE_FUNC(_name, ...) _DEFINE_COPROCR_WRITE_FUNC(_name, __VA_ARGS__)
...
#define DEFINE_COPROCR_READ_FUNC_64(_name, ...)  _DEFINE_COPROCR_READ_FUNC_64(_name, __VA_ARGS__)

/* Define 64 bit write function for coproc register */
#define DEFINE_COPROCR_WRITE_FUNC_64(_name, ...) _DEFINE_COPROCR_WRITE_FUNC_64(_name, __VA_ARGS__)
...
#define DEFINE_TLBIOP_FUNC(_op, ...)       _DEFINE_TLBIOP_FUNC(_op, __VA_ARGS__)

/* Define function for TLBI operation with register parameter */
#define DEFINE_TLBIOP_PARAM_FUNC(_op, ...) _DEFINE_TLBIOP_PARAM_FUNC(_op, __VA_ARGS__)

/* Define function for simple BPI operation */
#define DEFINE_BPIOP_FUNC(_op, ...)        _DEFINE_BPIOP_FUNC(_op, __VA_ARGS__)
...
#define DEFINE_DCOP_PARAM_FUNC(_op, ...) _DEFINE_DCOP_PARAM_FUNC(_op, __VA_ARGS__)
...
DEFINE_COPROCR_READ_FUNC(ifsr, IFSR)
DEFINE_COPROCR_READ_FUNC(dfsr, DFSR)
DEFINE_COPROCR_READ_FUNC(ifar, IFAR)
DEFINE_COPROCR_READ_FUNC(dfar, DFAR)
...
#define IS_IN_SECURE() (GET_NS_BIT(read_scr()) == 0)
